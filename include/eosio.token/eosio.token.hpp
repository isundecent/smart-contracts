...
namespace eosio {
   ...
   class [[eosio::contract("eosio.token")]] token : public contract {
      public:
         ...
         static constexpr eosio::name _dwfoundation = "dwfoundation"_n; // DWRLD issuing company
         static constexpr uint32_t _dwfoundation_claim_from_utc = 1654041600; //Jun 01 2022 00:00:00 GMT+0000
         static constexpr uint32_t _dwfoundation_claim_to_utc   = 2285193600; //Jun 01 2042 00:00:00 GMT+0000
         static constexpr uint32_t _dwfoundation_month_secs     =    2629800; //(2285193600-1654041600)/240, i.e. 30,4375 days
         static constexpr eosio::symbol _dcntwrldcoin_symbol    = eosio::symbol(eosio::symbol_code("DWRLD"), 4);
         static constexpr int64_t _dwfoundation_total_claim = 4000000000000;            // 10%   400'000'000.0000   DWRLD
         static constexpr double  _dwfoundation_month_claim = 4000000000000.0 / 240.0;  // monthly 1'666'666.666(6) DWRLD
      ...
      private:
         ...
         struct [[eosio::table]] token_claimer {
     		eosio::name claimer;
     		eosio::time_point_sec last_claim;
     		eosio::asset totally_received;

    		uint64_t primary_key() const { return claimer.value; }
         };
         typedef eosio::multi_index< "claimer"_n, token_claimer > claimer_index;
   };
